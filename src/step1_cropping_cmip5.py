...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Override the track_file value in the YAML configuration"
    )
    parser.add_argument(
        "--data_dir", "-dd",
        type=str,
        default=None,
        help="Override the data_dir value in the YAML configuration"
    )
    parser.add_argument(
        "--workdir", "-wd",
        default=None,
        help="Override the workdir value in the YAML configuration"
    )
    parser.add_argument(
        "--imsize_x", "-x",
        type=int,
        default=None,
        help="Override the crop width in the YAML configuration"
    )
    parser.add_argument(
        "--imsize_y", "-y",
        type=int,
        default=None,
        help="Override the crop height in the YAML configuration"
    )
    parser.add_argument(
        "--interpolation_steps",
        type=int,
        default=None,
        help="Override the number of positions generated per track interval",
    )
    parser.add_argument(
        "--timestep_hours",
        type=int,
        default=None,
        help="Override the hours between raw WRF files",
    )
    parser.add_argument(
        "--output_filename_template",
        default=None,
